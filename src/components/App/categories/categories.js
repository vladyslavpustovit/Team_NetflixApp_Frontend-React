...
function Categories() {
    ...
    return (
        <div className="mx-auto my-4 flex w-full gap-x-8 px-4 md:px-8 2xl:container">
            {isLoading && (
                    <svg aria-hidden="true" className="w-1/4 h-1/4 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="my-4 grid grid-cols-2 sm:grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-y-8 gap-x-4">
                {
